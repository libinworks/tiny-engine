      ...
      children: [
        {
          ...
          props: {
            style:
              'padding-top: 60px; padding-bottom: 0px; padding-left: 44px; padding-right: 44px; background-color: #fff;'
          },
          id: '30c94cc8',
          children: [
            {
              ...
              children: [
                {
                  ...
                  props: {
                    style:
                      "margin-top: 80px; text-align: center; font-size: 34px; font-weight: 500; line-height: 1.2; font-family: 'Source Han Sans CN';"
                  },
                  children: [
                    {
                      componentName: 'Text',
                ...
                },
                {
                  ...
                  props: {
                    style:
                      'text-align: center; margin-top: 2px; font-size: 23.5px; font-weight: 450; line-height: 1.2; font-family: SimHei;'
                  },
                  children: [
                    {
                      componentName: 'Text',
        ...
        },
        {
          ...
          props: {
            style:
              'padding-top: 46px; padding-bottom: 0px; padding-left: 44px; padding-right: 44px; background-color: #fff;'
          },
          children: [
            {
              componentName: 'Text',
            ...
            },
            {
              ...
              props: {
                border: '1',
                style:
                  'width: 100%; table-layout: fixed; border: 1px solid black; border-collapse: collapse; margin-top: 12px;'
              },
              children: [
                {
                  componentName: 'tr',
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed;',
                ...
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 88px;'
                  },
                  id: '44272315'
                },
                {
                ...
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 80px;'
                  },
                  id: '45332f62'
                },
                {
                ...
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 320px;'
                  },
                  id: '6e636354'
                }
              ],
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 230px;'
                  },
                  id: '64232457'
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 130px;'
                  },
                  id: '1535573e'
                },
                {
                  ...
                  props: {
                    style:
                      'border-collapse: collapse; word-break: break-word; overflow-wrap: break-word; table-layout: fixed; height: 150px;'
                  },
                  id: '33512416'
                },
                {
