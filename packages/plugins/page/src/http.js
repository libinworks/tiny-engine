...
import PageDetailData from './pageDetailData.js'
...
// 页面管理 -- 获取页面详情
export const fetchPageDetail = () => {
  // libin
// export const fetchPageDetail = (pageId) => {
  // return http.get(`/app-center/api/pages/detail/${pageId}`);
  return Promise.resolve(PageDetailData)
}
